...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        dismissClockFunc: [],
        dismissCalendarFunc: [],
        calendarDivName1: 'calendarbox', // title of calendar <div> that gets toggled
        calendarDivName2: 'calendarin', // title of <div> that contains calendar
        calendarLinkName: 'calendarlink', // title of the link that is used to toggle
        clockDivName: 'clockbox', // title of clock <div> that gets toggled
        clockLinkName: 'clocklink', // title of the link that is used to toggle
        ...
        addClock: function(inp) {
            ...
            // DateTimeShortcuts.clockHours.title = [['3 a.m.', 3]];
            // where title is the title attribute of the <input>.
